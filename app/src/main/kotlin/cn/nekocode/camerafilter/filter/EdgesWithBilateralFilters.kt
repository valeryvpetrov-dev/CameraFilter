...
class EdgesWithBilateralFilters(context: Context) : CameraFilter(context) {

    private val program: Int = buildProgram(context, R.raw.vertext, R.raw.edges_with_bilateral_filters)
