 ...
 */
class MappingFilter(context: Context) : CameraFilter(context) {
    private val program: Int = buildProgram(context, R.raw.vertext, R.raw.mapping)
    private val texture2Id: Int = loadTexture(context, R.raw.tex00, IntArray(2))
