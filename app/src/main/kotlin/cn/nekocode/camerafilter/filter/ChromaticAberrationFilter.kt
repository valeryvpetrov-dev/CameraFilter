 ...
 */
class ChromaticAberrationFilter(context: Context) : CameraFilter(context) {
    private val program: Int = buildProgram(context, R.raw.vertext, R.raw.chromatic_aberration)
